...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Frontend\\ProviderController' => 'getProviderControllerService',
            'App\\Controller\\Frontend\\TagController' => 'getTagControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('yGF-fr47t6', 0, ($this->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('d0is0WJVo8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'serverVersion' => '14', 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'fos_elastica.listener.images' => ['privates', 'fos_elastica.listener.images', 'getFosElastica_Listener_ImagesService', true],
            'fos_elastica.listener.provider' => ['privates', 'fos_elastica.listener.provider', 'getFosElastica_Listener_ProviderService', true],
            'fos_elastica.listener.tags' => ['privates', 'fos_elastica.listener.tags', 'getFosElastica_Listener_TagsService', true],
        ], [
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
            'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber' => '?',
            'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber' => '?',
            'fos_elastica.listener.images' => '?',
            'fos_elastica.listener.provider' => '?',
            'fos_elastica.listener.tags' => '?',
        ]), [0 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 1 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 2 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners'], 3 => [0 => [0 => 'postPersist'], 1 => 'fos_elastica.listener.images'], 4 => [0 => [0 => 'postUpdate'], 1 => 'fos_elastica.listener.images'], 5 => [0 => [0 => 'preRemove'], 1 => 'fos_elastica.listener.images'], 6 => [0 => [0 => 'postFlush'], 1 => 'fos_elastica.listener.images'], 7 => [0 => [0 => 'postPersist'], 1 => 'fos_elastica.listener.tags'], 8 => [0 => [0 => 'postUpdate'], 1 => 'fos_elastica.listener.tags'], 9 => [0 => [0 => 'preRemove'], 1 => 'fos_elastica.listener.tags'], 10 => [0 => [0 => 'postFlush'], 1 => 'fos_elastica.listener.tags'], 11 => [0 => [0 => 'postPersist'], 1 => 'fos_elastica.listener.provider'], 12 => [0 => [0 => 'postUpdate'], 1 => 'fos_elastica.listener.provider'], 13 => [0 => [0 => 'preRemove'], 1 => 'fos_elastica.listener.provider'], 14 => [0 => [0 => 'postFlush'], 1 => 'fos_elastica.listener.provider']]), []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\ProvidersRepository' => ['privates', 'App\\Repository\\ProvidersRepository', 'getProvidersRepositoryService', true],
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1laJLC5dkQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0fPL1XQwcr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('R6xMsMNCMI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['api_platform.listener.request.deserialize'] = new \ApiPlatform\Core\EventListener\DeserializeListener(($this->privates['debug.serializer'] ?? $this->getDebug_SerializerService()), ($this->privates['api_platform.serializer.context_builder.filter'] ?? $this->getApiPlatform_Serializer_ContextBuilder_FilterService()), ($this->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Resource_MetadataFactory_CachedService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MxecG56XGT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('c5zhpJu0de', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('F4ozhO2lYD', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('if9vXIIeCm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bMXHwZFxcv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getDebug_SerializerService()
    {
        ...
        $d = new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\JsonEncoder(), $b);

        $e = new \ApiPlatform\Core\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $a, $c)], [0 => $d]));

        $f = new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(new \Symfony\Component\Serializer\Debug\TraceableNormalizer($e, $b)), $b);
        ...
        $l = new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer($g, $h, $i, ($this->privates['api_platform.hydra.json_schema.schema_factory'] ?? $this->getApiPlatform_Hydra_JsonSchema_SchemaFactoryService()), ($this->privates['api_platform.json_schema.type_factory'] ?? $this->getApiPlatform_JsonSchema_TypeFactoryService()), ($this->privates['api_platform.operation_path_resolver.router'] ?? $this->getApiPlatform_OperationPathResolver_RouterService()), NULL, $j, NULL, false, 'oauth2', 'application', '', '', [], [], $k, true, 'page', false, 'itemsPerPage', $this->parameters['api_platform.formats'], false, 'pagination', [], $this->parameters['api_platform.swagger.versions'], ($this->privates['api_platform.identifiers_extractor.cached'] ?? $this->getApiPlatform_IdentifiersExtractor_CachedService()), $e), $b)), $b);
        ...
        $t = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($r);
        $u = new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($r, $n, $a, $c, $t, NULL, []), $b);

        return $this->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), $b), 1 => $f, 2 => $l, 3 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($m, [], $n), $b), 4 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $n), $b), 5 => $l, 6 => $f, 7 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($g, $h, $i, $o, NULL, $m, $k, $n), $b), 8 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($g, $p, $m), $b), 9 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($m, true), $b), 10 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), $b), 11 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), $b), 12 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $b), 13 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($g, $h, $i, $p, $o, $q, $a, $n, $r, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $s), $b), 14 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Serializer\ItemNormalizer($h, $i, $p, $o, $a, $n, $r, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $g, $s), $b), 15 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), $b), 16 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $n), $b), 17 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($r, $n, $c, $t, NULL, [])), $b), 18 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $b), 19 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), $b), 20 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $b), 21 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $b), 22 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), $b), 23 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), $b), 24 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($q, $o, $p), $b), 'page', 'pagination', $g, $a), $g, $o, $j), 25 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $b), 26 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($u, $p, $q), $b), 27 => $u], [0 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $b), 1 => $d, 2 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), $b), 3 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder(), $b), 4 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), $b), 5 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem'), $b)]), $b);
    }
    ...
    {
        return $this->privates['fos_elastica.logger'] = new \FOS\ElasticaBundle\Logger\ElasticaLogger(($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), true);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'fos_elastica.default_index' => 'images',
            'nelmio_cors.map' => [
                '^/' => [
