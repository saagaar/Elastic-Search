 ...
 */
class getFosElastica_Index_ProviderService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'fos_elastica.index.provider' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['fos_elastica.index.provider'] = ($container->privates['fos_elastica.client.default'] ?? $container->load('getFosElastica_Client_DefaultService'))->getIndex('provider');
    }
}
