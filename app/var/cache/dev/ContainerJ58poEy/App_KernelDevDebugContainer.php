...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getDebug_SerializerService()
    {
        ...
        $t = new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($r, $n, $a, $c, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($r), NULL, []), $b);
        ...
        return $this->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), $b), 1 => $f, 2 => $l, 3 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($m, [], $n), $b), 4 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $n), $b), 5 => $l, 6 => $f, 7 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($g, $h, $i, $o, NULL, $m, $k, $n), $b), 8 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($g, $p, $m), $b), 9 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($m, true), $b), 10 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), $b), 11 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), $b), 12 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $b), 13 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($g, $h, $i, $p, $o, $q, $a, $n, $r, [], new RewindableGenerator(function () {
            ...
            return new \EmptyIterator();
        }, 0), $g, $s), $b), 15 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), $b), 16 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $n), $b), 17 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $b), 18 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), $b), 19 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $b), 20 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $b), 21 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), $b), 22 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), $b), 23 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($q, $o, $p), $b), 'page', 'pagination', $g, $a), $g, $o, $j), 24 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $b), 25 => new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($t, $p, $q), $b), 26 => $t], [0 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $b), 1 => $d, 2 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), $b), 3 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder(), $b), 4 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), $b), 5 => new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem'), $b)]), $b);
    }
