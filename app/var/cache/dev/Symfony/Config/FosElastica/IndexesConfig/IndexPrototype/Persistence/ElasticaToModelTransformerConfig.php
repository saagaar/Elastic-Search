...
class ElasticaToModelTransformerConfig 
{
    ...
    public function __construct(array $value = [])
    {
        if (array_key_exists('hints', $value)) {
            $this->_usedProperties['hints'] = true;
            $this->hints = array_map(function ($v) { return new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ElasticaToModelTransformer\HintsConfig($v); }, $value['hints']);
            unset($value['hints']);
        }
