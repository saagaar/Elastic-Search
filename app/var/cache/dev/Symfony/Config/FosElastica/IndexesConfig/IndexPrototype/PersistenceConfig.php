...
namespace Symfony\Config\FosElastica\IndexesConfig\IndexPrototype;
...
class PersistenceConfig 
{
    ...
    */
    public function provider(array $value = []): \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ProviderConfig
    {
        if (null === $this->provider) {
            $this->_usedProperties['provider'] = true;
            $this->provider = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ProviderConfig($value);
    ...
    */
    public function listener(array $value = []): \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ListenerConfig
    {
        if (null === $this->listener) {
            $this->_usedProperties['listener'] = true;
            $this->listener = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ListenerConfig($value);
        } elseif (0 < \func_num_args()) {
    ...
    public function finder(array $value = []): \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\FinderConfig
    {
        if (null === $this->finder) {
            $this->_usedProperties['finder'] = true;
            $this->finder = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\FinderConfig($value);
        } elseif (0 < \func_num_args()) {
    ...
    */
    public function elasticaToModelTransformer(array $value = []): \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ElasticaToModelTransformerConfig
    {
        if (null === $this->elasticaToModelTransformer) {
            $this->_usedProperties['elasticaToModelTransformer'] = true;
            $this->elasticaToModelTransformer = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ElasticaToModelTransformerConfig($value);
        } elseif (0 < \func_num_args()) {
    ...
    public function modelToElasticaTransformer(array $value = []): \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ModelToElasticaTransformerConfig
    {
        if (null === $this->modelToElasticaTransformer) {
            $this->_usedProperties['modelToElasticaTransformer'] = true;
            $this->modelToElasticaTransformer = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ModelToElasticaTransformerConfig($value);
        } elseif (0 < \func_num_args()) {
    ...
    public function persister(array $value = []): \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\PersisterConfig
    {
        if (null === $this->persister) {
            $this->_usedProperties['persister'] = true;
            $this->persister = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\PersisterConfig($value);
        } elseif (0 < \func_num_args()) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('provider', $value)) {
            $this->_usedProperties['provider'] = true;
            $this->provider = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ProviderConfig($value['provider']);
            unset($value['provider']);
        }

        if (array_key_exists('listener', $value)) {
            $this->_usedProperties['listener'] = true;
            $this->listener = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ListenerConfig($value['listener']);
            unset($value['listener']);
        }

        if (array_key_exists('finder', $value)) {
            $this->_usedProperties['finder'] = true;
            $this->finder = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\FinderConfig($value['finder']);
            unset($value['finder']);
        }

        if (array_key_exists('elastica_to_model_transformer', $value)) {
            $this->_usedProperties['elasticaToModelTransformer'] = true;
            $this->elasticaToModelTransformer = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ElasticaToModelTransformerConfig($value['elastica_to_model_transformer']);
            unset($value['elastica_to_model_transformer']);
        }

        if (array_key_exists('model_to_elastica_transformer', $value)) {
            $this->_usedProperties['modelToElasticaTransformer'] = true;
            $this->modelToElasticaTransformer = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\ModelToElasticaTransformerConfig($value['model_to_elastica_transformer']);
            unset($value['model_to_elastica_transformer']);
        }

        if (array_key_exists('persister', $value)) {
            $this->_usedProperties['persister'] = true;
            $this->persister = new \Symfony\Config\FosElastica\IndexesConfig\IndexPrototype\Persistence\PersisterConfig($value['persister']);
