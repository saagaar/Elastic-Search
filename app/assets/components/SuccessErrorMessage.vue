...
<div  v-if="status=='success'" >
  <div id="message-data"> 
  <div class="msg-icon"><i class="fa fa-check-circle text-success" ></i></div>
  <div class="msg-icon"> <span v-html="message"></span></div></div>
</div>
<div class="" v-if="status=='error'">
  <div id="message-data"  >
  <div class="msg-icon"> <i class="fa fa-exclamation-triangle text-warning"></i> </div>
  <div class="msg-icon"><span v-html="message"></span></div>
</div>
</div>
</div>
</template>
