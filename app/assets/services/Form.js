...
export default class Form {
            ...
            data() {
                  ...
                  let ndata=this.originalData;
                   if(this.originalData.file)
                   {
                        ...
                        for(let property in ndata) {
                            if((form[property] instanceof Array) ||(form[property] instanceof Object) ) {
             ...
             createFormData(form, data, key) {
                var fd=form ;
             if( typeof data === 'object' && data !== null && (data.constructor.name=='FileList' || data.constructor.name=='File'))
             {
                    fd.append(key , data);
             }
